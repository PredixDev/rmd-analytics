        ...
        implements IRefAppAnalytic
{
            ...
            Map<String, FieldData> calculatedOutputMap)
    {
        ...
        log.info("Get Field Data ===>Request........................." + putRequest);

        HttpResponse putResponse = this.restClient.post(this.fdhRestConfig.getPutFieldDataEndPoint(), putRequest, headers);
    ...
    private Map<String, FieldData> resolveData(RunAnalyticRequest request, List<Header> headers)
    {
        ...
        HttpResponse getFieldDataResponse = this.restClient.post(this.fdhRestConfig.getGetFieldDataEndPoint(), getRequest, headers);
